...
<head>
    ...
    <link rel="stylesheet" href="../asset/css/serverlog.css">
	 <link rel="stylesheet" href="../asset/css/log.css">

    <title>Server_Login</title>
</head>
...
<body onclick="ShowTime()">
    <div id="log-board1">
        <p id="log-top1">管理者登入</p>
        <div　id="log-content1">
            <form method="POST" action="checkserver.jsp">
			 ...
			 <button class="add-button" onclick="document.getElementById('id02').style.display='block'" >點擊我註冊管理者！</button>

            <div id="id02" class="modal">

                <form class="modal-content animate" method="post" action="addserver.jsp">
                    <fieldset class="data">
                        <legend>
                            <br><br>
                            <h2>管理者註冊</h2>
            ...
            <button id="member-button" onclick="location.href='login.jsp'">
                <h3>回到會員登入</h3>
            </button>
        </div>
    </div>
